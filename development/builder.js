...
class HomepageFile extends BuildFile {
  ...
  getRunExtensionURL(extensionSlug) {
    return `https://potentiamod.github.io/online/editor.html?extension=${this.getFullExtensionURL(
      extensionSlug
    )}`;
  }
  ...
  getRunSampleURL(sampleFile) {
    ...
    return `https://potentiamod.github.io/online/editor.html?project_url=${this.host}${path}`;
  }
